...
import com.zjtt.service.ContentService;
import org.springframework.beans.factory.annotation.Autowired;
import com.github.pagehelper.Page;
import com.github.pagehelper.PageHelper;
import com.zjtt.mapper.TbContentMapper;
import com.zjtt.pojo.TbContent;
import com.zjtt.pojo.TbContentExample;
import com.zjtt.pojo.TbContentExample.Criteria;
...
public class ContentServiceImpl implements ContentService {
	...
	/**
	 * 通过contentCategory的id查询，并且是状态为有效的图片（1）
	 * @param cid
	 * @return
	 */
	@Override
	public List<TbContent> findContentByCid(long cid) {
		...
		if(contentList==null){
			...
			criteria2.andCategoryIdEqualTo(cid);
			criteria2.andStatusEqualTo("1");//开启状态
			contentExample.setOrderByClause("sort_order");//排序
			contentList = contentMapper.selectByExample(contentExample);//获取广告列表
			redisTemplate.boundHashOps("content").put(cid, contentList);//存入缓存
		}else{
